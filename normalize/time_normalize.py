...
from normalize.utils.funcs import bracket, bracket_absence, absence
from normalize.utils.money_parser import MoneyParser
from normalize.utils.lunar_solar_date import LunarSolarDate
from normalize.utils.rule.rule_pattern import *
import logging
...
def normalize(text):
    try:
        return {'gte': _parser(text)['time'][0], 'lte': _parser(text)['time'][1]}
    except:
        return {}
