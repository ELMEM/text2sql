...
from normalize.utils.funcs import start_end
from normalize.utils.rule.rule_pattern import CURRENCY_CASE, \
...
from normalize.utils.rule import extract_parentheses, remove_parentheses
...
def normalize(text: str):
    try:
        return {'value': int(float(_parser(text)['num']))}
    except:
        return {}
